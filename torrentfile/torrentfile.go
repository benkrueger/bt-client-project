...
func (ti *TorrentInfo)OpenTorrentInfo(file_path string) {


}
func (t *TorrentInfo)OpenFile(file_path string) {

}
func (t *TorrentInfo) GetTracker() string {
	return t.tracker
}
func (t *TorrentInfo) GetFilePath() string {
	return t.filepath
}
func (t *TorrentInfo) GetLength() int64 {
	return t.length
}
func (t *TorrentInfo) GetName() string {
	return t.name
}
func (t *TorrentInfo) GetPrivate() bool {
	return t.private
}
func (t *TorrentInfo) GetInfohash() string {
	return t.infohash
}
func (t *TorrentInfo) GetAnnouce() string {
	return t.announce
}

func (t *TorrentInfo) SetTracker() {
	if t.announce != "" {
